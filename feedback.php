...
<div class="col-md-10">
<a href="mailto:tkshubhashree@gmail.com" style="color:#000000">tkshubhashree@gmail.com</a><br /><br />
...
<a href="overview.png" target="_blank">Overview</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		 <div class="col-md-5">
     <h4 style="font-family:'typo' ">SHUBHASHREE TK</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9353710273</h4>
		<h4 style="font-family:'typo' ">tkshubhashree@gmail.com</h4>
		<h4 style="font-family:'typo' ">Chikkathirupathi Malur(T) Kolor(D) PIN code 563160</h4></div></div>
		</p>
      </div>
